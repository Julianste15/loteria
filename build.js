...
${gridButtonsHtml}      </div>
    ...
    <!-- Modal de Confirmación Personalizado (Dentro de main para soporte de Fullscreen nativo) -->
    <div id="custom-confirm-modal" class="modal" aria-hidden="true" role="dialog" aria-labelledby="modal-title" aria-describedby="modal-message">
      <div class="modal-content">
        <h2 id="modal-title" class="modal-title">¿Confirmar acción?</h2>
        <p id="modal-message" class="modal-message">Descripción de la acción</p>
        <div class="modal-actions">
          <button id="btn-modal-cancel" class="btn" aria-label="Cancelar la acción">Cancelar</button>
          <button id="btn-modal-confirm" class="btn" aria-label="Confirmar la acción e iniciar">Confirmar</button>
        </div>
      </div>
    </div>
  </main>
